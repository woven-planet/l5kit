...
from ..geometry import agent_pose, angular_distance, rotation33_as_yaw, transform_point
...
to train models that can recover from slight divergence from training set data
    ...
    if perturbation is not None:
        history_frames, future_frames[:12] = perturbation.perturb(
            history_frames=history_frames, future_frames=future_frames[:12]
        )
