...
def test_transform_points() -> None:
    ...
    tf = np.asarray(
        [[-1.08912448e+00, 2.25029062e+00, 6.03325482e+03],
         [-2.25029062e+00, -1.08912448e+00, -1.28582624e+03],
         [0.0, 0.0, 1.0]]
    )
    points = np.array([[0, 10], [10, 0], [10, 10]])
    expected_points = np.array(
        [[6055.757726, -1296.717485],
         [6022.363575, -1308.329146],
         [6044.866481, -1319.220391]]
    )
