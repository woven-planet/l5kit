...
* 12-03-2020: We've just released a series of notebooks to train and evaluate an ML planning model. We've also included pre-trained models! Learn more about this in the dedicated `REAMDE <./examples/planning/README.md>`_
...
.. * 06-25-2020: Docs and API available at `https://lyft.github.io/l5kit/ <https://lyft.github.io/l5kit/>`_  (thanks Kevin Zhao!)
